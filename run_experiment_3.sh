...
EVALUATIONS_REPO=KegBias/evaluations-experiment3
BASE_MODEL_NAME=bert-base-cased
DO_TRAINING=false
DO_EVALUATION=true
#NO_NAMES_IN_TEMPLATES=true
NO_NAMES_IN_TEMPLATES=false
...
do
    ...
    if $NO_NAMES_IN_TEMPLATES
    then
        EXPERIMENT_NAME=${BASE_MODEL_NAME}_femaleBiased-init_no-names_v${TRIAL_NO}
    ...
    then
        EXPERIMENT_NAME=${BASE_MODEL_NAME}_femaleBiased-init_with-names_v${TRIAL_NO}
